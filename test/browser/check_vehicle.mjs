...
// 4. 현장 — 차량 없으면 왜 저장이 안 되는지 알려 주는가
{
  ...
  //  ⚠ 0128 — 계정에 차를 묶지 않으므로 「담당 차량 미지정」은 더 이상 없습니다.
  //     남은 진짜 문제는 **차가 한 대도 등록 안 됐을 때**뿐이고, 그때는
  //     고를 것이 없으니 사무실에 문의해야 합니다.
  ok(/고를 수 있는 차량이 없습니다/.test(t),'차량이 한 대도 없다고 알려 줌 (0129 — 구분으로 거르지 않으므로 문구도 구분을 안 씁니다)')
  ok(!/담당 차량이 지정되지 않았습니다/.test(t),'「담당 차량 미지정」으로 겁주지 않음 (0128)')
