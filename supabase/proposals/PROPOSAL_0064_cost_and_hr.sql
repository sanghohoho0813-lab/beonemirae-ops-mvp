-- ═══════════════════════════════════════════════════════════════════════════
--  0064 (제안) — 병원에게 매입원가를, 현장에게 동료 개인정보를 닫습니다
--
--  ⚠ 이 파일은 **아직 실행하지 마세요.** 대표님 승인 뒤에 돌립니다.
--     지시 ⑫ 「migration 실행은 승인 전에는 하지 않는다」를 지킵니다.
--
--  ── 왜 필요한가 ──────────────────────────────────────────────────────────
--
...
--
--   1. (제가) 앱에서 원가를 product_costs() 로 읽되, **함수가 없으면
--      조용히 예전 방식으로 읽도록** 고칩니다 (client_billing_terms 와 같은
--      방식). 이러면 SQL 전에도 후에도 화면이 멀쩡합니다.
--   2. 앱 배포 → 화면이 그대로인지 확인
