...
| `src/components/Layout.tsx` (0129) | 오늘 날짜·시각을 계정 카드 아래에서 **사이드바 맨 위 고정 줄**로 옮김 (`data-clock-top` · sticky · 21px 흰 글자) | 대표님: 「상단에 고정시켜 잘 보이게」 | P0 — Pilot 에서 담당차량 불일치가 수거 저장을 막음 |
