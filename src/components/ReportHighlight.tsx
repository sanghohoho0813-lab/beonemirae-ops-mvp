  ...
  return (
    <div className="card flex h-full flex-col overflow-hidden">
      <div className="border-b border-navy-100 px-5 py-5">
        <p className="text-[1.12rem] font-bold text-navy-500">병원 운영 리포트</p>
      ...
      <div className="flex-1 divide-y divide-navy-50">
        ...
        {top.length === 0 && (
          <p className="px-5 py-8 text-center text-[1.12rem] text-navy-400">아직 생성된 리포트가 없습니다.</p>
        )}
      </div>

      <button
        onClick={() => navigate('/reports')}
        className="pressable m-4 rounded-xl bg-navy-900 py-3.5 text-[1.12rem] font-bold text-white transition hover:bg-navy-800"
      >
        운영 리포트 보기
      </button>
    </div>
