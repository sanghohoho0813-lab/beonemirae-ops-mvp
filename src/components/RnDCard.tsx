    ...
    <div className="card overflow-hidden">
      <div className="flex items-center gap-2.5 bg-gradient-to-br from-navy-800 to-navy-900 px-5 py-4 text-white">
        ...
        <div className="leading-tight">
          ...
          <p className="text-[0.82rem] font-medium text-navy-300">R&amp;D · 데이터 기반 운영 시스템</p>
        </div>
      </div>
      ...
      <div className="p-5">
        <ul className="space-y-2.5">
          {ITEMS.map((t) => (
            <li key={t} className="flex items-start gap-2.5">
              ...
              <span className="text-[0.95rem] font-medium leading-snug text-navy-700">{t}</span>
            </li>
          ))}
        </ul>
        ...
        <div className="mt-4 flex items-center gap-2.5 rounded-2xl bg-navy-50 px-4 py-3">
          ...
          <div className="leading-tight">
            <p className="text-[0.82rem] font-semibold text-navy-400">특허출원번호</p>
            <p className="text-[0.95rem] font-extrabold tracking-tight text-navy-900">10-2026-0101187</p>
          </div>
        </div>
      </div>
    </div>
