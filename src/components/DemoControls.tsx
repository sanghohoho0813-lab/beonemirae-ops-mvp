  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded-full bg-white px-3.5 py-2 text-sm font-bold text-navy-500 shadow-card transition hover:bg-navy-50 ${className}`}
      >
      ...
      >
        ...
        <ul className="mt-3 space-y-1 rounded-2xl bg-navy-50 p-3 text-[0.8125rem] text-navy-500">
...
export function DemoSettingsPanel() {
  ...
  return (
    <div className="rounded-2xl bg-navy-50/70">
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex w-full items-center gap-2 rounded-2xl px-3 py-2.5 text-[0.8125rem] font-bold text-navy-500 transition hover:bg-navy-100"
      >
      ...
      {open && (
        <div className="space-y-1.5 px-2 pb-2.5">
          <button
            ...
            className="flex w-full items-center gap-2 rounded-xl bg-white px-2.5 py-2 text-[0.8125rem] font-semibold text-navy-600 transition hover:bg-navy-50"
          >
          ...
          <p className="px-1 pt-0.5 text-[0.625rem] leading-snug text-navy-400">
