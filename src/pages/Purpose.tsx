  ...
  return (
    ...
    <PageShell className="mx-auto max-w-[58rem]">
      <div>
        ...
        {/*  0083 — 고객 포털이 생기면서 이야기가 한 단계 넓어졌습니다.
             ⚠ 「AI 가 다 해 줍니다」처럼 부풀리지 않습니다. 지금 실제로 된
               것(내부 운영 + 병원 화면이 한 시스템)과, 아직 안 된 것(그
               자료로 하는 AI 분석)을 나눠서 적습니다. 정책자금 문구처럼
               보이지 않게 하는 것이 이 문단의 조건입니다. */}
        <p data-purpose-platform className="t-body mt-3 break-keep font-bold text-navy-700">
          지금은 여기까지 왔습니다 — 비원미래의 내부 운영과 <b className="text-navy-900">의료기관 고객 화면</b>이
          하나의 시스템 안에서 이어집니다. 병원이 포털에서 올린 요청·문의가 그대로 저희 운영 화면으로 들어오고,
