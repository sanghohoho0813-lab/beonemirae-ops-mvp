...
export function CollectionHistory() {
  ...
  return (
    <div>
      <button onClick={() => navigate(-1)} className="mb-3 flex items-center gap-1.5 text-sm font-bold text-navy-500">
      ...
      <div className="mb-4 grid grid-cols-2 gap-3 lg:grid-cols-4">
        <div className="card p-4">
          <p className="text-[0.8125rem] font-semibold text-navy-400">전체 수거건수</p>
        ...
        <div className="card p-4">
          <p className="text-[0.8125rem] font-semibold text-navy-400">총 수거량</p>
          <p className="mt-1.5 whitespace-nowrap text-[1.625rem] font-extrabold text-teal-600">{weight(totalKg)}</p>
        </div>
        <div className="card p-4">
          <p className="text-[0.8125rem] font-semibold text-navy-400">긴급수거</p>
        ...
        <div className="card p-4">
          <p className="text-[0.8125rem] font-semibold text-navy-400">인계 완료율</p>
      ...
      {rows.length > 60 && <p className="mt-2 px-1 text-xs text-navy-400">최근 60건까지 표시합니다.</p>}
    </div>
  )
}
