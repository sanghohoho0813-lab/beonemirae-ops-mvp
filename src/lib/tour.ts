...
const STAFF: Tour = {
  ...
  steps: [
    ...
    },
    {
      ...
      action: '저장을 누르면 다섯 군데가 한꺼번에 갱신됩니다 — 오늘 일정, 수거이력, 자재 재고, 병원 요청 상태, 그 달 정산.',
    ...
    },
    {
      ...
      anchor: 'client-list',
      title: '거래처별로 쌓입니다',
      action: '거래처를 누르면 그동안의 수거량, 자재 사용량, 요청, 매출이 한 화면에 모여 있습니다.',
      result: '「이 병원이 요즘 용기를 더 쓰는가」를 기억에 기대지 않고 확인합니다.',
      why: '지금까지 담당자 머릿속에만 있던 것이라, 사람이 바뀌면 같이 사라졌습니다.',
    },
    {
      route: '/stats',
      anchor: 'business-summary',
      title: '월 정산과 거래명세서',
      action: '현장에서 들어온 기록만으로 매출·처리비·자재비·예상 영업이익이 계산됩니다.',
    ...
    },
    {
      ...
      title: '병원이 직접 요청합니다',
      action: '병원 담당자가 포털에서 추가 수거나 소모품을 올리면 여기 바로 뜹니다. 상태를 바꾸고 회신을 적으면 병원 화면에 그대로 보입니다.',
...
const FIELD: Tour = {
  ...
  steps: [
    ...
    },
    {
      ...
      result: '「20L 용기 30개」를 적으면 창고 재고에서 30개가 빠지고, 그 거래처 이번 달 정산에도 같이 올라갑니다.',
  ...
  steps: [
    {
      ...
      result: '비원미래 담당자 화면에 바로 뜹니다. 통화 연결을 기다리지 않으셔도 됩니다.',
    },
    {
      route: '/portal',
